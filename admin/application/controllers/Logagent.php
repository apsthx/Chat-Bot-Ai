...
class Logagent extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('logagent_model');
    ...
    public function index() {
        ...
        $this->renderView('logagent_view', $data);
    }
    ...
    public function ajax_pagination() {
        ...
        $count = $this->logagent_model->count_pagination($filter);
        $config['div'] = 'result-pagination';
        $config['base_url'] = base_url('logagent/ajax_pagination');
        ...
        $data = array(
            'data' => $this->logagent_model->get_pagination($filter, array('start' => $segment, 'limit' => $this->per_page)),
            'count' => $count,
            'segment' => $segment,
            'links' => $this->ajax_pagination->create_links()
        );
        $this->load->view('ajax/logagent_pagination', $data);
    }
