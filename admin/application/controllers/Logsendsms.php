...
class Logsendsms extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('logsendsms_model');
    ...
    public function index() {
        ...
        $this->renderView('logsendsms_view', $data);
    }
    ...
    public function ajax_pagination() {
        ...
        $count = $this->logsendsms_model->count_pagination($filter);
        $config['div'] = 'result-pagination';
        $config['base_url'] = base_url('logsendsms/ajax_pagination');
        ...
        $data = array(
            'data' => $this->logsendsms_model->get_pagination($filter, array('start' => $segment, 'limit' => $this->per_page)),
            'count' => $count,
            'segment' => $segment,
            'links' => $this->ajax_pagination->create_links()
        );
        $this->load->view('ajax/logsendsms_pagination', $data);
    }
