...
class Dialogflows extends CI_Controller {
    ...
    public function auth($test) {
        putenv('GOOGLE_APPLICATION_CREDENTIALS=' . APPPATH . 'third_party/Credentials/'.$test);
    ...
    public function agentGet() {
        // auth
        $httpClient = $this->auth('a-erbtbt-868552141718.json');
...
//    }
     ...
     public function agentSearch() {
        ...
        // request
        $response = $httpClient->get('https://dialogflow.googleapis.com/v2/projects/' . '-' . '/agent:search');
