            ...
            <div class="card-body">
                <h4 class="card-title">
                    ...
                    <span style="float: right">
                        ...
                        <a href="<?php echo base_url('groupmenu/sortgroupmenu'); ?>" class="btn btn-sm btn-rounded btn-outline-info"><i class="fa fa-sort"></i> จัดเรียงกลุ่มเมนู</a>
                    </span>
                </h4>
                                ...
                                foreach ($datas->result() as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo base_url('groupmenu/menu/' . $data->group_menu_id); ?>" class="btn btn-sm btn-outline-warning"><i class="fa fa-list"></i> จัดการเมนู</a>
...
<div id="add-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="add-form" method="post" action="<?php echo base_url('groupmenu/addgroupmenu'); ?>" autocomplete="off">
...
<div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="edit-form" method="post" action="<?php echo base_url('groupmenu/editgroupmenu'); ?>" autocomplete="off">
...
<script>
    ...
    function modaledit(group_menu_id) {
        ...
        $('#group_menu_name').val('');
        $('#group_menu_icon').val('');
        let url = service_base_url + 'groupmenu/getgroupmenu';
        $.ajax({
            url: url,
            method: 'POST',
            dataType: 'JSON',
    ...
    function modaldelete(group_menu_id) {
        let url = service_base_url + 'groupmenu/deletegroupmenu/' + group_menu_id;
