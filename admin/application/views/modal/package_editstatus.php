<div id="on_modal" tabindex="-1" role="dialog" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-material m-t-10" method="post" action="<?php echo base_url() . 'package/editstatus'; ?>" autocomplete="off">
                ...
                <div class="modal-body">
                    <div class="bootbox-body">
                        ...
                        <br/>
                        <h4 class="text-center"><i class='fa fa-close'></i> ต้องการระงับแพ็กเกจ</h4>
                        <br/>
                    </div>                    
                </div>
