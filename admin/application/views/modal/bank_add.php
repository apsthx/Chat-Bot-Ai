<div id="on_modal" tabindex="-1" role="dialog" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="form_modal" class="form-horizontal" method="post" action="<?php echo base_url() . 'bank/addbank'; ?>" autocomplete="off">
                        ...
                        <select class="form-control col-sm-10" name="bank_icon_id" id="bank_icon_id" onchange="changeBank()">
                            ...
                            if ($bank_icons->num_rows() > 0) {
                                foreach ($bank_icons->result() as $icon) {
                                    ?>
                                    <option value="<?php echo $icon->bank_icon_id ?>"><?php echo $icon->bank_name ?></option>
                                    <?php
                                }
                            }
                            ?>
                        </select>
                        <span class="col-sm-1"><i class="thbanks thbanks-bbl" id="bank_icon"></i></span>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-form-label"> ธนาคาร: <span class="text-danger">*</span></label>
                        <input type="text" name="bank_name" id="bank_name" value="ธ.กรุงเทพ" class="form-control"  required="">
                    </div>  
                    <div class="form-group">
