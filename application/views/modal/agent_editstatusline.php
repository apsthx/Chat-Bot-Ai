<div id="on_modal" tabindex="-1" role="dialog" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="m-t-10" method="post" action="<?php echo base_url() . 'main/editstatusline'; ?>" autocomplete="off">
                <div class="modal-header">
                    <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;ปิดการใช้งาน Line </h4>
                ...
                <div class="modal-body">
                    <div class="bootbox-body">
                        ...
                        <br/>
                        <h4 class="text-center"><i class='fa fa-close'></i> ต้องการปิดการใช้งาน Line</h4>
                        <br/>
                    </div>                    
                </div>
