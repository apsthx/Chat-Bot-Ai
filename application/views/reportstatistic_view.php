...
<!--                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <select id="hook_project_id" class="form-control form-control-sm" onchange="ajax_pagination();">
                            ...
                            <?php foreach ($this->reportstatistic_model->get_agent()->result() as $agent) { ?>
...
<!--                    <div class="col-lg-2">
                    ...
                    <div class="col-lg-9">
                        <div class="text-right">
                            <span> วันที่ </span>
                            <input type="text" id="start_date_input" class="form-control form-control-sm col-sm-2" value="<?php echo date('d/m') . '/' . (date('Y') + 543); ?>" onchange="date_convert('start_date_input', 'date_start_report')" required="">
                            ...
                            <span> ถึง </span>
                            <input type="text" id="end_date_input" class="form-control form-control-sm col-sm-2" value="<?php echo date('d/m') . '/' . (date('Y') + 543); ?>" onchange="date_convert('end_date_input', 'date_end_report')" required="">
...
<script>
    ...
    function ajax_pagination() {
        ...
        $.ajax({
            url: service_base_url + 'reportstatistic/ajax_page',
            type: 'POST',
            data: {
